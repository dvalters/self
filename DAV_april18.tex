...
\begin{itemize}
	...
	\headerrow
		...
		{\textbf{github.com/GCEL}}
	\\
	\headerrow
		{\emph{Numerical models, model evaluation frameworks, and utilities for Ecological modelling}}
		{\emph{November 2017 -- present}}
	\begin{itemize*}
		\item Extended functionality of the LVT (Land Surface Verification Toolkit) to read JULES input data. (\textbf{Fortran}) 
		\item Development of a python interface to the SPECCHIO spectral information system. (\textbf{Python})
		\item Implementation of git version control and support of best practices in software engineering for scientists in the research group.
			\end{itemize*}
	...
	\\
	\headerrow
		{\emph{Scientific workflow management and configuration software (\textbf{Python})}}
	...
	\begin{itemize*}
		\item A \textbf{C++} cellular automaton model ported to HPC (High performance computing) facilities through a shared-memory parallelism model (\textbf{OpenMP}). 
	...
	\headerrow
		...
		{\emph{2012 -- present}}
	\begin{itemize*}
		\item Object-oriented \textbf{{\CPP}} topographic analysis and modelling package developed with the Land Surface Dynamics research group at Edinburgh. The continuing aim of the project is to implement state-of-the art algorithms as they are published in academic literature. A key aim of LSDTopoTools is to facilitate reproducible scientific data analysis for large topographic datasets.
